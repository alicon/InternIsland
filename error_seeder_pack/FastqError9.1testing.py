...
def decide_if_error(fastq_dict, infile, status_updates, pileup_dict):
...
def main(args):
    ...
    error_dict = decide_if_error(fastq_dict, infile, status_updates, pileup_dict)
    if status_updates:
